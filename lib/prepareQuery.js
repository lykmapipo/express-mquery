...
module.exports = function( /*options*/ ) {
    ...
    return function(req, res, next) {
        ...
        for (var key in req.query) {
            ...
            if (key === 'query') {
                try {
                    req.mquery[key] = JSON.parse(req.query[key], jsonQueryParser);
                } catch (e) {
                ...
                try {
                    req.mquery[key] = JSON.parse(req.query[key]);
                } catch (e) {
                    req.mquery[key] = req.query[key];
                }
            } else {
                req.mquery[key] = req.query[key];
            }
        ...
        req.mquery = parseQueryOptions(req.mquery);
